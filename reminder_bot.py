...
O'rnatish: pip install python-telegram-bot apscheduler
"""
...
# ============================================================
BOT_TOKEN = "BU_YERGA_BOT_TOKEN_YOZING"   # @BotFather dan oling
...
async def start(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    kb = [
        ...
        [InlineKeyboardButton("ℹ️ Yordam / Help",    callback_data="help")],
    ]
    text = (
        f"🌟 *Assalomu alaykum, {name}!*\n\n"
...
async def buttons(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if data.startswith("done_"):
        ...
        await query.message.reply_text(f"✅ *Bajarildi!* Zo'r, *{name}*! 👏",
                                       parse_mode="Markdown")
        return
...
# ── Bot qayta ishga tushganda eslatmalarni yuklash ───────────
